...
@protocol GAPHttpSessionDelegate<NSObject>
 ...
 */
@protocol GAPJsonHttpSessionDelegate <GAPHttpSessionDelegate>
...
@interface GAPHttpSession : NSObject {
...
@property(nonatomic, weak, nullable) id<GAPHttpSessionDelegate> httpSessionDelegate;
