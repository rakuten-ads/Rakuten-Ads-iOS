...
//! Project version number for MediationAdapterObj.
FOUNDATION_EXPORT double RUNAMediationAdapterVersionNumber;

//! Project version string for MediationAdapterObj.
FOUNDATION_EXPORT const unsigned char RUNAMediationAdapterVersionString[];
