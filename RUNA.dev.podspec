...
This repository is used to distribute #{s.name} iOS SDK for CocoaPods users.
  ...
  s.platform     = :ios, "10.0"
  s.source       = {
    :http => "https://storage.googleapis.com/rssp-dev-cdn/sdk/ios/dev/#{s.version}/RUNA_iOS_#{s.version}.framework.zip"
  }
  s.vendored_frameworks = "Carthage/Build/iOS/RUNA.framework"
