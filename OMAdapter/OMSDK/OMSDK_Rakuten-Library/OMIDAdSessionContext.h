 ...
 */
@interface OMIDRakutenAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDRakutenPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDRakutenPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDRakutenVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
