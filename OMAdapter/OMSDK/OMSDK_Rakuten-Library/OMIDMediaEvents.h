 ...
 */
@interface OMIDRakutenMediaEvents : NSObject
 ...
 * @see OMIDAdSession
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDRakutenAdSession *)session error:(NSError *_Nullable *_Nullable)error;
 ...
 */
- (void)loadedWithVastProperties:(nonnull OMIDRakutenVASTProperties *)vastProperties;
