 ...
 */
@interface OMIDRakutenAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDRakutenAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDRakutenAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDRakutenAdSessionContext *)context
