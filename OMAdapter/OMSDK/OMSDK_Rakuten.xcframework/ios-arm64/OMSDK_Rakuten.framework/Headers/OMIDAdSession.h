 ...
 */
@property(nonatomic, readonly) OMIDRakutenAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDRakutenAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDRakutenAdSessionContext *)context
