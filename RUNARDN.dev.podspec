#
#  Be sure to run `pod spec lint RUNARDN.podspec' to ensure this is a
...
This repository is used to distribute #{s.name} iOS SDK for CocoaPods users.
  ...
  s.platform     = :ios, "10.0"
  s.source       = {
    :http => "https://storage.googleapis.com/rssp-dev-cdn/sdk/ios/dev/#{s.version}/RUNARDN_iOS_#{s.version}.framework.zip"
  }
  s.vendored_frameworks = "Carthage/Build/iOS/RUNARDN.framework"

  s.frameworks = "Foundation", "AdSupport", "SystemConfiguration", "WebKit", "UIKit"
  s.dependency 'RUNACore.dev', '0.0.2'
end
