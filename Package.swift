...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RUNABanner",
            url: "https://storage.googleapis.com/rssp-dev-cdn/sdk/ios/prod/RUNABanner/RUNABanner_iOS_1.11.0.xcframework.zip",
            checksum : "58fdb6285c2d92ce32b6775dc2550432d67eac22fbfda7f1fc67896778439185"
        ),
        .binaryTarget(
            name: "RUNAOMAdapter",
