...
//! Project version number for RDN.
FOUNDATION_EXPORT double RPSRDNVersionNumber;

//! Project version string for RDN.
FOUNDATION_EXPORT const unsigned char RPSRDNVersionString[];
